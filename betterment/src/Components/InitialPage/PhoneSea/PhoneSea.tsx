...
function PhoneSea() {
  return (
    <>
      <div className="relative overflow-hidden w-full h-full flex items-start justify-end">
        <img
          className="w-[911px] absolute lg:relative bottom-0  2xl:right-[-4rem] max-lg:right-[-18rem] right-[-13rem]"
          src={phoneImg}
